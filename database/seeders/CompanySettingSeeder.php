...
class CompanySettingSeeder extends Seeder
{
    ...
    public function run()
    {
        if (!CompanySetting::exists()) {
            ...
            $setting->company_name = 'HrHub Company';
            $setting->company_email = 'hrhub@gmail.com';
            $setting->company_phone = '09251010101' ;
            $setting->company_address = 'Hlaing TownShip, Yangon';
